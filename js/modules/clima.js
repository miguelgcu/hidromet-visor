...
(() => {
  ...
  // Tarjeta de cifra, al ámbito del módulo: las dos copias locales de
  // tarjetaPunto y tarjetaArea la tapan sin cambiar nada.
  ...
  // Superficie pura para las pruebas Node de Climatología. Hasta el 2026-09-17
  // este bloque exportaba TAMBIÉN las funciones del IUV; al sacar el IUV a su
  // propio módulo se fue entero con él y clima.js se quedó sin superficie de
  // prueba, con `rangoMapaDiario` exportada desde un fichero donde no existe.
  // Lo destapó `prueba_clima_mapa_diario.js` al correrla con node instalado.
